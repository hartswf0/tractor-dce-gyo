...
const DEFS = {
  ...
  'odysseus-sword': { name: 'Odysseus with the sword', legs: 297, hips: 308, torso: 308, arms: 308, hands: 84, head: 84, hat: ['10054', 0], melee: true, weapon: ['sword', '3847', 72], cape: ['522', 320], collar: ['2587', 297], face: 'halfworld:odysseus' },
  'odysseus-bow': { name: 'Odysseus with the bow', legs: 297, hips: 308, torso: 308, arms: 308, hands: 84, head: 84, hat: ['10054', 0], bow: true, weapon: ['bow', '93231', 70], cape: ['522', 320], collar: ['2587', 297], face: 'halfworld:odysseus' },
...
function step(rig, dt, ctl, world) {
  ...
  if (ctl.saber && !rig.swing && rig.def && (rig.def.saber || rig.def.melee)) rig.swing = { t0: rig.t, struck: false };
  let u = null;
  if (rig.swing) {
