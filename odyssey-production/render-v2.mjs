...
const bed=await build('rooted-bed',[
 ...
 {op:'column',x:repaired?46:47,z:-18,y:0,h:5,col:70},
 {op:'box',x:44,z:-19,w:5,d:1,y:0,h:1,col:70},
...
function cameraAt(t,ts){
 ...
 else if(t<22.9){pos=repaired?[1260,250,110]:[1100,215,-160];target=[1000,50,-310];fov=repaired?46:39;label='THE SECRET · chamber visualization';}
