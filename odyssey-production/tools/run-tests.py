...
suite.append(('voice-channel','../tests/voice-channel.cjs','Mocked audio-only recording, transcription review, cancellation, commands and read-only discussion; not a real microphone/API test.'))
results=[]
