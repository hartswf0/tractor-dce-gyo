...
const DEFS = {
  ...
  clerk: { name: 'The clerk', legs: 72, hips: 72, torso: 4, arms: 4, hands: 14, head: 14, headPart: '3626bp3r', hat: ['3901', 0], weapon: null },   /* the checkout clerk in The List: a printed face (stubble, a frown) for the close-up at the till */
  ...
  maggie: { name: 'Maggie', legs: 1, hips: 1, torso: 1, arms: 1, hands: 14, head: 14, hat: null, weapon: null, sculpt: true, short: true, baby: true, faces: { wide: '15525p01', worried: '15525p02' }, parts: [['hips', '15526', 1, [0, -24, 0]], ['head', '15525p02', 14, [0, 20, 0]]] },   /* the baby body (15526, 63 LDU, neck at its top) seated so its base is the short figure's feet, the head on its neck */
  ...
  ethan: { name: 'Ethan', legs: 28, hips: 308, torso: 272, arms: 272, hands: 78, head: 78, headPart: '3626bp81', hat: ['3629', 28], weapon: null },   /* printed LEGO heads for The Searchers: stubble and a crooked mouth */
  martha: { name: 'Martha', legs: 272, hips: 272, torso: 15, arms: 15, hands: 78, head: 78, headPart: '3626bp09', hat: ['3625', 70], weapon: null, woman: true },
  aaron: { name: 'Aaron', legs: 308, hips: 308, torso: 71, arms: 71, hands: 78, head: 78, headPart: '3626bp3q', hat: ['3901', 70], weapon: null },
  mose: { name: 'Mose Harper', legs: 28, hips: 28, torso: 19, arms: 19, hands: 78, head: 78, headPart: '3626bp8m', hat: ['3629', 70], weapon: null },   /* the old man in the rocking chair: white beard and sideburns under a brown hat, the pale duster the film gives him, light against the dark rocker and the log wall */
...
function mount(rig, groups, def, scene) {
  ...
  groups.forEach((g, i) => { const slot = parts[i][0], off = parts[i][3]; g.position.set(off ? off[0] : 0, off ? off[1] : slot === 'hat' && def.bare ? 24 : 0, off ? off[2] : 0);   /* a part may carry its own offset in its slot (LDU, LDraw frame): a baby's body is not a pair of hips */ g.quaternion.identity(); g.scale.setScalar(1); g.name = slot; rig.slots[slot].add(g); /* a whole-head mask has its origin at the neck, a hat at the crown */ rig.mounted[slot] = { group: g, part: parts[i][1], col: parts[i][2] };
