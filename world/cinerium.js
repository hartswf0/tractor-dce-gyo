...
const PHRASES = {
  ...
  shrug: { 'arm.L.pitch': -60 * A, 'arm.R.pitch': -60 * A, 'arm.L.out': 0.35, 'arm.R.out': 0.35, 'hand.L.roll': -1.4, 'hand.R.roll': 1.4, 'hips.drop': -3, 'brow.up': .6, 'frown': .25, 'torso.roll': 0.08 },
  wave: { 'arm.R.pitch': -160 * A, 'smile': .5 },
  'hands on hips': { 'arm.L.pitch': 25 * A, 'arm.R.pitch': 25 * A, 'arm.L.out': 0.3, 'arm.R.out': 0.3, 'hand.L.roll': 1.5, 'hand.R.roll': -1.5 },
