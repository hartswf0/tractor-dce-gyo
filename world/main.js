...
Object.assign(W, {
  ...
  receipts: () => Receipts.all(), receiptsClear: () => Receipts.clear(), manifest: () => Ai.manifest(), setLook: on => W.setLook(on), look: () => W.master.look !== false, plan: () => W.master.plan || null, snapshotLen: () => (snapshot(320, 180) || '').length, context: () => { const c = mbContext({ image: false }); return { ...c, image: undefined }; },
