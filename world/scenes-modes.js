...
SCENES['mode-ride'] = { name: 'At the wheel', as: 'han', time: 'day',
  ...
  shots: [
    ...
    { name: 'The road', score: 'chase', on: 'me', frame: 'medium', from: 'se', move: 'hold', sec: 6, follow: true, act: { ahead: 30 }, events: [{ what: 'LINE', who: 'narrator', text: 'Up drives, sideways steers, two fingers boost.', at: 0.6 }] },
    { name: 'Behind the wheel', on: 'me', frame: 'pov', sec: 4, follow: true, act: { ahead: 25 } },
    { name: 'The shot', on: 'me', frame: 'medium', from: 'ne', move: 'hold', sec: 4, follow: true, act: { ahead: 20, fire: true }, events: [{ what: 'SOUND', who: 'blaster', at: 0.8 }, { what: 'SOUND', who: 'blaster', at: 1.6 }] },
