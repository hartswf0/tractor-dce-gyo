...
SCENES['mode-walk'] = { name: 'On foot', as: 'luke', time: 'day',
  ...
  shots: [
    ...
    { name: 'The look', on: 'me', frame: 'shoulder', from: 's', move: 'hold', sec: 3, act: { look: 'crowd' } },
...
SCENES['mode-ride'] = { name: 'At the wheel', as: 'han', time: 'dusk',
  ...
  shots: [
    ...
    { name: 'The road', score: 'chase', on: 'me', frame: 'wide', from: 'e', move: 'track', sec: 6, follow: true, act: { ahead: 60 }, events: [{ what: 'LINE', who: 'narrator', text: 'Up drives, sideways steers, two fingers boost.', at: 0.6 }] },
    { name: 'Behind the wheel', on: 'me', frame: 'pov', sec: 4, follow: true, act: { ahead: 50 } },
    { name: 'The shot', on: 'me', frame: 'medium', from: 'n', move: 'hold', sec: 4, follow: true, act: { ahead: 40, fire: true }, events: [{ what: 'SOUND', who: 'blaster', at: 0.8 }, { what: 'SOUND', who: 'blaster', at: 1.6 }] },
    { name: 'The brake', on: 'me', frame: 'low', from: 'w', move: 'push', sec: 3, follow: true, act: { brake: true }, events: [{ what: 'SOUND', who: 'skid', at: 0.3 }] },
