...
Film.SCENES['case-grocery'] = { name: 'The List', time: 'day', weather: 'clear', ground: 'flat', me: 'off', part: 'homer', set: { kind: 'stage', r: 120, seed: 2 }, marksHidden: true,
  ...
  shots: [
    ...
    { name: 'The store', on: 'homer', title: LIST('milk', 'bread', 'eggs'), style: 'list', pos: [9, 3.4, -36], pos2: [7, 3.0, -32], tgt: [0, 4.2, -15], lens: 45, sec: 7.84, shift: 'store', look: STORE,
      acts: [{ who: 'homer', to: 'in', walk: true, at: 0.5 }, { who: 'cart', lead: 'homer', ahead: 1.6 }, { who: 'lisa', follow: 'homer', behind: 1.4, walk: true }],
    ...
    { name: 'The list', on: 'homer', title: LIST('milk', 'bread', 'eggs'), style: 'list', pos: [1.2, 2.3, -8.4], tgt: [-0.3, 2.0, -12.2], lens: 38, sec: 3.95, shift: 'list', look: STORE,
      acts: [{ who: 'cart', lead: 'homer', ahead: 1.6 }, { who: 'lisa', look: 'homer' }],
    ...
    { name: 'The aisle', on: 'homer', title: LIST('milk', 'bread', 'eggs'), style: 'list', pos: [3.2, 2.3, 13.0], tgt: [3.0, 2.2, -5], lens: 36, sec: 7.89, shift: 'aisle', look: STORE,
      acts: [{ who: 'homer', to: 'aisle-s', via: [[0.2, -8.4], [3.0, -6.2]], walk: true }, { who: 'cart', lead: 'homer', ahead: 1.6 }, { who: 'lisa', follow: 'homer', behind: 1.4, walk: true }, { who: 'bart', to: [2.4, 2.4], at: 2.2 }],
    ...
    { name: 'No eggs', on: 'homer', title: LIST('~milk', '~bread', '?eggs', '+fireworks'), style: 'list', pos: [-0.8, 2.1, 8.0], tgt: [3.2, 1.6, 14.2], lens: 34, sec: 5.91, shift: 'dairy', look: STORE,
      acts: [{ who: 'homer', to: 'dairy', walk: true }, { who: 'cart', lead: 'homer', ahead: 1.4 }, { who: 'lisa', follow: 'homer', behind: 1.4, walk: true }, { who: 'bart', follow: 'homer', behind: 2.2 }],
    ...
    { name: 'The belt', on: 'cart', title: LIST('~milk', '~bread', '?eggs', '+fireworks'), style: 'list', pos: [8.4, 1.8, -6.0], tgt: [5.8, 1.1, -11.4], lens: 40, sec: 7.89, shift: 'belt', look: STORE,
      acts: [{ who: 'homer', to: 'lane', via: [[3.0, -6.2], [3.4, -8.6]] }, { who: 'cart', lead: 'homer', ahead: 1.4 }, { who: 'lisa', follow: 'homer', behind: 1.6 }, { who: 'bart', follow: 'homer', behind: 2.4 }, { who: 'clerk', look: 'cart' }],
    ...
    { name: 'It scanned', on: 'homer', title: LIST('~milk', '~bread', '?eggs', '+fireworks', '+Maggie'), style: 'list', pos: [0.6, 2.2, -5.4], tgt: [5.2, 1.8, -11.2], lens: 38, sec: 7.89, shift: 'scan', look: STORE,
      acts: [{ who: 'homer', look: 'clerk' }, { who: 'cart', lead: 'homer', ahead: 1.4 }, { who: 'lisa', to: [2.3, -11.6], walk: true }, { who: 'bart', to: [1.4, -12.4], walk: true }],   /* the children step aside to the west, out of the line from the camera to Homer */
