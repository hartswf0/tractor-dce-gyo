...
Film.SCENES['case-grocery'] = { name: 'The List', time: 'day', weather: 'clear', ground: 'flat', me: 'off', part: 'homer', set: { kind: 'stage', r: 120, seed: 2 }, marksHidden: true,
  ...
  shots: [
    ...
    { name: 'The belt', on: 'cart', title: LIST(...STRUCK(5)), style: 'list', record: ['green bananas', 'black berries', 'extra virgin olive oil', '?plain flour', 'southwest hash browns'], pos: [-6.4, 3.6, -18.9], tgt: [-8.4, 1.2, -13.4], lens: 40, sec: 7.89, shift: 'belt', look: STORE,   /* from the lobby, south-east of lane one: Homer and the cart in front, the belt and the clerk behind, Ned in the next lane with his book */
    ...
    { name: 'The record', on: 'flanders', title: LIST(...STRUCK(5), '+Maggie'), style: 'list', record: ['green bananas', 'black berries', 'extra virgin olive oil', '?plain flour', 'southwest hash browns'], pos: [-3.2, 3.4, -17.9], tgt: [-10.6, 1.3, -14.6], lens: 36, sec: 7.89, shift: 'record', look: STORE,
