...
Film.SCENES['case-grocery'] = { name: 'The List', time: 'day', weather: 'clear', ground: 'flat', me: 'off', part: 'marge', set: { kind: 'stage', r: 120, seed: 2 }, marksHidden: true,
  ...
  marks: { street: [-2.4, -19], in: [-0.3, -12], 'aisle-n': [0.1, -5.8], 'aisle-s': [0.1, 7.6], dairy: [-0.4, 12.4],   /* aisle five's floor is x −2..1: Marge walks its east side, Flanders stands on its west, both clear of the shelves */
    lane: [4.6, -11.2], belt: [6.3, -9.3],   /* Maggie at the south end of the belt, by the scanner */ clerk: [8.4, -11.8], queue: [2.4, -11.9], produce: [-15.2, -8.8], ned: [-1.25, 2.6] },
  actors: [
    { name: 'marge', figure: 'marge', label: 'Marge', x: -2.4, z: -19, heading: 180 },
    { name: 'maggie', figure: 'maggie', label: 'Maggie', x: 6.3, z: -9.3, heading: 270 },   /* already at the end of the belt, by the scanner: she is first seen there */
    { name: 'homer', figure: 'homer', label: 'Homer', x: -15.2, z: -8.8, heading: 0 },
    { name: 'clerk', figure: 'citizen', label: 'the clerk', x: 8.4, z: -11.8, heading: 270 },
    { name: 'flanders', figure: 'flanders', label: 'Ned Flanders', x: -1.25, z: 2.6, heading: 90 }],
  ...
  shots: [
    ...
    { name: 'The list', on: 'marge', title: LIST('milk', 'bread', 'eggs'), style: 'list', pos: [5.5, 2.3, -26], pos2: [3.5, 2.0, -22.5], tgt: [-0.5, 2.6, -14], lens: 40, sec: 7.84, shift: 'door', look: STORE,
      acts: [{ who: 'marge', to: 'in', walk: true, at: 0.6 }],
    ...
    { name: 'Produce', on: 'homer', title: LIST('milk', 'bread', 'eggs'), style: 'list', pos: [-10.6, 2.0, -5.8], tgt: [-15, 1.5, -10.4], lens: 40, sec: 3.95, shift: 'produce', look: STORE,
      acts: [{ who: 'marge', to: 'aisle-n', walk: true, at: 0.2 }, { who: 'homer', look: 'marge' }],
    ...
    { name: 'Aisle five', on: 'marge', title: LIST('milk', 'bread', 'eggs'), style: 'list', pos: [-0.3, 2.3, 12.8], tgt: [-0.5, 1.5, -5], lens: 36, sec: 7.89, shift: 'aisle', look: STORE,
      acts: [{ who: 'marge', to: 'aisle-s', walk: true }, { who: 'flanders', look: 'marge' }],
    ...
    { name: 'No eggs', on: 'marge', title: LIST('~milk', 'bread', '?eggs'), style: 'list', pos: [-4.0, 2.0, 8.2], tgt: [-0.2, 1.6, 14.4], lens: 34, sec: 5.91, shift: 'dairy', look: STORE,
      acts: [{ who: 'marge', to: 'dairy', walk: true }],
    ...
    { name: 'The belt', on: 'maggie', title: LIST('~milk', '~bread', '?eggs', '+donuts'), style: 'list', pos: [8.2, 1.6, -6.2], tgt: [7.0, 1.1, -10.8], lens: 40, sec: 7.89, shift: 'belt', look: STORE,
      acts: [{ who: 'marge', to: 'lane', via: [[3.0, 11.4], [3.0, -5.8], [3.8, -8.4]] }, { who: 'homer', to: 'queue', walk: true, at: 0.5 },   /* Marge runs the back aisle and up aisle six (floor x 1.5..4.5), not through the shelves; she gets to the lane after 'Baby.' */ { who: 'clerk', look: 'maggie' }, { who: 'maggie', look: 'clerk' }],
    ...
    { name: 'It scanned', on: 'marge', title: LIST('~milk', '~bread', '?eggs', '+donuts', '+Maggie'), style: 'list', pos: [1.0, 2.2, -5.8], tgt: [5.4, 1.8, -11.4], lens: 38, sec: 7.89, shift: 'scan', look: STORE,
