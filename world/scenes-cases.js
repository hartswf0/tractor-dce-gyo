...
Film.SCENES['case-plato'] = { name: "The Cave", time: 'night', weather: 'clear', ground: 'flat', me: 'off', part: 'freed',
  ...
  marks: { row: [0, -4, 0], screen: [0, -11, 15], parapet: [0, 6.2, 4], fire: [0, 13, 14], slope: [-9, -2, 25], out: [-18, 4, 14], side: [-4, -3, 2] },
  actors: [
  ...
  shots: [
    ...
    { name: 'The climb', on: 'freed', pos: [-6, 3.0, 6], tgt: [-10, 1.6, -2], lens: 40, sec: 8, shift: 'climb',
    ...
    { name: 'The sun', on: 'out', pos: [-24, 2.2, 12], tgt: [-18, 1.8, 4], lens: 46, sec: 6, shift: 'sun', set: { kind: 'desert', r: 40, seed: 5, time: 'dawn' }, look: { hemi: 0.5, sun: 1.2, elev: 12, azim: 180, exposure: 1.0 },
