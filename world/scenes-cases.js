...
Film.SCENES['case-grocery'] = { name: 'The List', time: 'day', weather: 'clear', ground: 'flat', me: 'off', part: 'homer', set: { kind: 'stage', r: 120, seed: 2 }, marksHidden: true,
  ...
  marks: {
    ...
    belt: [...SM(48.4, 19.5), null, 0], 'cart-belt': [...SM(48, 16.2), null, 0], clerk: [...SM(42.8, 16.6), null, 90], 'ned-belt': [...SM(39.6, 16.5), null, 0], 'bart-belt': [...SM(48.2, 11.8), null, 0], 'lisa-belt': [...SM(50.4, 11.5), null, 0] },
  actors: [
  ...
  shots: [
    ...
    { name: 'The store', on: 'homer', title: LIST(...ALL5), style: 'list', pos: [10.2, 3.2, -7.4], pos2: [9.6, 3.1, -8.0], tgt: [1.0, 1.4, -18.4], lens: 40, sec: 7.84, shift: 'store', look: STORE,
    ...
    { name: 'The list', on: 'homer', title: LIST(...ALL5), style: 'list', record: [], pos: [1.4, 2.9, -11.6], tgt: [0, 2.1, -15.4], lens: 36, sec: 3.95, shift: 'list', look: STORE,
      acts: [{ who: 'homer', from: 'in', look: 'list-look' }, { who: 'cart', from: 'cart-in', brake: true }, { who: 'bart', from: 'bart-in', look: 'homer' }, { who: 'lisa', from: 'lisa-in', look: 'homer' }, { who: 'flanders', look: 'homer' }],
    ...
    { name: 'Green', on: 'homer', title: LIST(...ALL5), style: 'list', record: ['green bananas'], pos: [29.8, 3.0, -13.6], tgt: [22.0, 1.3, -10.4], lens: 40, sec: 7.89, shift: 'produce', look: STORE,
    ...
    { name: 'Aisle three', on: 'homer', title: LIST(...STRUCK(2)), style: 'list', record: ['green bananas', 'black berries'], pos: [1.5, 3.3, -6.8], tgt: [2.6, 1.5, 4.0], lens: 36, sec: 5.91, shift: 'aisle', look: STORE,
    ...
    { name: 'Caught', on: 'homer', title: LIST(...STRUCK(4)), style: 'list', record: ['green bananas', 'black berries', 'extra virgin olive oil', '?plain flour'], pos: [-24.6, 3.1, -9.6], tgt: [-27.0, 1.5, 1.2], lens: 38, sec: 7.89, shift: 'frozen', look: STORE,
    ...
    { name: 'The belt', on: 'cart', title: LIST(...STRUCK(5)), style: 'list', record: ['green bananas', 'black berries', 'extra virgin olive oil', '?plain flour', 'southwest hash browns'], pos: [-2.8, 3.3, -12.2], tgt: [-9.4, 1.2, -15.6], lens: 40, sec: 7.89, shift: 'belt', look: STORE,   /* from the lobby, south-east of lane one: Homer and the cart in front, the belt and the clerk behind, Ned in the next lane with his book */
    ...
    { name: 'The record', on: 'flanders', title: LIST(...STRUCK(5), '+Maggie'), style: 'list', record: ['green bananas', 'black berries', 'extra virgin olive oil', '?plain flour', 'southwest hash browns'], pos: [-5.0, 2.9, -10.6], tgt: [-10.2, 1.4, -15.8], lens: 34, sec: 7.89, shift: 'record', look: STORE,
