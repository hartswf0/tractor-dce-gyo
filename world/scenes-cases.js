...
Film.SCENES['case-grocery'] = { name: 'The List', time: 'day', weather: 'clear', ground: 'flat', me: 'off', part: 'homer', set: { kind: 'stage', r: 120, seed: 2 }, marksHidden: true,
  ...
  marks: {
    ...
    apples: [...SM(113.5, 24.4), null, 180], crate: SM(113.5, 28), 'cart-apples': [...SM(116.9, 28), null, 180], 'ned-apples': [...SM(117.4, 32.5), null, 0], 'lisa-apples': [...SM(116.4, 23.6), null, 270], 'bart-apples': [...SM(111.5, 19.2), null, 180],
  ...
  shots: [
    ...
    { name: 'Five red apples', on: 'homer', title: LIST(...ALL5), style: 'list', record: [], pos: [23.0, 2.7, -13.9], tgt: [26.2, 1.2, -9.9], lens: 42, sec: 7.89, shift: 'apples', look: STORE,
