...
const KINDS = {
  ...
  horse: { cruise: 2.6, boost: 6, turn: 1.4, fly: false, hover: 0, ram: 0.4, accel: 2.5, grip: 9, horse: true, seat: 0.7 },   // seat: the rider's feet line over the hooves in metres (the saddle is 1.43 m up)   // a horse at a walk: the film drives it at a fraction of its cruise
