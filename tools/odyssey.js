...
function compile(id) {
  ...
  const hall = { name: 'megaron', ops: [{ op: 'group', name: 'floor', x: -24, z: -32, size: [48, 34, 1], ops: [{ op: 'slab', x: 0, z: 0, w: 48, d: 34, y: 0, plates: 1, col: 19 }] }, { op: 'group', name: 'far wall', x: -24, z: -33, size: [48, 1, 9], ops: [{ op: 'wall', from: [0, 0], to: [48, 0], y: 0, h: 9, col: 28 }, { op: 'band', x: 0, z: 0, w: 48, d: 1, y: 7, h: 1, col: 4 }] }, { op: 'group', name: 'great doors', x: -4, z: -33, size: [8, 1, 7], ops: [{ op: 'cut', x: 0, z: 0, w: 8, d: 1, y: 0, h: 7 }, { op: 'door', x: 0, z: 0, y: 0, facing: 's', col: 70 }, { op: 'door', x: 4, z: 0, y: 0, facing: 's', col: 70 }] }, { op: 'group', name: 'left pillar', x: -10, z: -26, size: [2, 2, 9], ops: [{ op: 'column', x: 0, z: 0, y: 0, h: 9, col: 15 }, { op: 'column', x: 1, z: 0, y: 0, h: 9, col: 15 }, { op: 'column', x: 0, z: 1, y: 0, h: 9, col: 15 }, { op: 'column', x: 1, z: 1, y: 0, h: 9, col: 15 }] }, { op: 'group', name: 'right pillar', x: 8, z: -26, size: [2, 2, 9], ops: [{ op: 'column', x: 0, z: 0, y: 0, h: 9, col: 15 }, { op: 'column', x: 1, z: 0, y: 0, h: 9, col: 15 }, { op: 'column', x: 0, z: 1, y: 0, h: 9, col: 15 }, { op: 'column', x: 1, z: 1, y: 0, h: 9, col: 15 }] }, { op: 'group', name: 'the fire', x: -2, z: -22, size: [4, 4, 2], ops: [{ op: 'box', x: 0, z: 0, w: 4, d: 4, y: 0, h: 1, col: 72 }, { op: 'part', part: '3062b', col: 25, x: 1, y: 1, z: 1 }, { op: 'part', part: '3062b', col: 46, x: 2, y: 1, z: 2 }, { op: 'part', part: '4589', col: 25, x: 1, y: 2, z: 2 }] }] };
