...
const SCENE_SET = { 'OD-B05-S05': 'storm', 'OD-B12-S03': 'sirens', 'OD-B12-S04': 'strait', 'OD-B12-S07': 'wreck', 'OD-B10-S01': 'voyage', 'OD-B13-S01': 'voyage', 'OD-B09-S11': 'boast', 'OD-B17-S03': 'argos', 'OD-B09-S03': 'lotus', 'OD-B05-S04': 'ogygia', 'OD-B12-S06': 'thrinacia', 'OD-B21-S07': 'megaron', 'OD-B06-S03': 'river', 'OD-B11-S01': 'underworld', 'OD-B19-S04': 'megaron', 'OD-B22-S01': 'megaron', 'OD-B23-S04': 'chamber', 'OD-B10-S02': 'harbor', 'OD-B10-S05': 'forest', 'OD-B02-S02': 'megaron', 'OD-B24-S03': 'farm', 'OD-B24-S05': 'farm' };
const SEA = new Set(['sirens', 'strait', 'storm', 'wreck', 'voyage', 'boast', 'lotus', 'ogygia', 'thrinacia', 'river', 'underworld', 'harbor']);
/* cast the atlas leaves out but the text needs on stage: Eurylochus's scouts, the men Circe turns (Homer X: "twenty-two men") */
const SCENE_CAST = { 'OD-B02-S02': [{ id: 'ensemble.web-suitors', name: 'four suitors', type: 'ensemble' }, { id: 'character.melantho', type: 'character' }], 'OD-B24-S03': [], 'OD-B19-S04': [{ id: 'character.penelope', type: 'character' }], 'OD-B10-S04': [{ id: 'ensemble.circe-scouts', name: 'five scouts', type: 'ensemble' }], 'OD-B21-S07': [{ id: 'ensemble.bow-suitors', name: 'six suitors', type: 'ensemble' }] };
