...
const SCENE_CAST = { 'OD-B04-S05': [{ id: 'ensemble.menelaus-men', name: 'three men', type: 'ensemble' }], 'OD-B02-S02': [{ id: 'ensemble.web-suitors', name: 'four suitors', type: 'ensemble' }, { id: 'character.melantho', type: 'character' }], 'OD-B24-S03': [], 'OD-B19-S04': [{ id: 'character.penelope', type: 'character' }], 'OD-B10-S04': [{ id: 'ensemble.circe-scouts', name: 'five scouts', type: 'ensemble' }], 'OD-B21-S07': [{ id: 'ensemble.bow-suitors', name: 'six suitors', type: 'ensemble' }] };
