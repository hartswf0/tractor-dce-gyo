...
const ROLES = {
  ...
  queen: r => ({ torso: '973p0w', top: choose(r, [C.dred, C.purple, C.dblue, C.white]), legs: C.white, face: FACE.lady, hat: [HAIR.bun, choose(r, [C.dbrown, C.black])], R: ['2343', C.gold] }),
  ...
  servant: r => ({ torso: choose(r, ['973p3y', '973p3a', '973']), top: choose(r, [C.tan, C.dtan, C.rbrown]), legs: choose(r, [C.rbrown, C.dtan, C.tan]), face: choose(r, [FACE.man, FACE.rough, FACE.droop]), hat: [choose(r, [HAIR.male, HAIR.short]), choose(r, [C.dbrown, C.black, C.lbg])], R: [choose(r, ['4496', '2343', '4332']), C.rbrown] }),
  ...
  nymph: r => ({ torso: '973p0w', top: choose(r, [C.sgreen, C.dturq, C.white]), legs: C.white, face: FACE.lips, hat: [choose(r, [HAIR.braid, HAIR.female]), choose(r, [C.yellow, C.dbrown])], R: ['36752a', C.white] }),
