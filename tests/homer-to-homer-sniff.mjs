...
await page.getByRole('button',{name:'CAST'}).click();await page.getByRole('button',{name:/Poseidon/}).click();await page.waitForTimeout(1000);await page.screenshot({path:'homer-sniff/poseidon-full-mobile.png',fullPage:true});
await page.getByRole('button',{name:'ASSEMBLY'}).click();await page.getByRole('button',{name:'HEAD / MAKEUP'}).click();await page.waitForTimeout(800);await page.screenshot({path:'homer-sniff/poseidon-head-mobile.png',fullPage:true});
